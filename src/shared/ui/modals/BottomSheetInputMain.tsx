...
type BottomSheetInputMainProps = {
  value: string;
...
export const BottomSheetInputMain = ({
  value,
  onChange,
  icon,
  errorText,
  ...
  const containerAnimatedStyle = useAnimatedStyle(() => ({
    borderColor: interpolateColor(errorProgress.value, [0, 1], [
      interpolateColor(focusProgress.value, [0, 1], ['transparent', FOCUS_COLOR]),
      ERROR_COLOR,
    ]),
  }));
