...
type ProfilePasswordChangeModalNavigationProp = CompositeNavigationProp<
...
export const ProfilePasswordChangeModal = forwardRef<BottomSheetModal>((_, ref) => {
    const {t} = useTranslation('profile', {i18n});
    const navigation = useNavigation<ProfilePasswordChangeModalNavigationProp>();
    ...
    const handleYesPress = () => {
        ...
        navigation.navigate('Profile', {
            screen: 'ProfilePasswordChangeEmail',
        });
    };
    ...
    return (
        <CenterModal ref={sheetRef}>
            <View style={styles.container}>
                <Text style={styles.title}>{t('password_change_modal_title')}</Text>
                <InfoCard text={t('password_change_modal_info')} style={styles.infoCard}/>
